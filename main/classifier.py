...
"""
this module trains linearSVM classifier on the provided cars/notcars data
the extracted data is used from extract_features_and_scale.py run, the contents of the file is copied
into __main__ section
...
####################copy of extract features file to avoid dependency#####################
...
##########################################################################################
    ...
    pickle_fname='colorspace_'+color_space+'_spatialbin_'+str(spatial_feat)+'_colhist_'+str(hist_feat)+'_rbf_'+'.p'
